...
# test
is_finetune_test = False
is_pretrain_test = False
is_guide_test = False
...
root_dir = '/home/amax/lab_data/surgicalData/cholec80_data/remain_time/remain_time'
anna_dir = '/home/amax/lab_data/surgicalData/cholec80_data/data.pkl'
model_name = 'resnet50'
...
if is_finetune:  # if finetune the CNN model
    ...
    dataloaders_dict = make_dataloader_dict(root_dir=root_dir, annotation_path=anna_dir, is_finetune=is_finetune,
                                            ...
                                            n_sample_for_each_video=n_sample_for_each_video)
    if is_guide_train:
        train_guide(dataloaders_dict, pre_guide_weight_out.format('10'), guided_weight_out, num_epochs=100)
